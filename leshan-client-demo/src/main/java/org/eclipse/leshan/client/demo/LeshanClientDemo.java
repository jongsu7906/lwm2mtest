...
public class LeshanClientDemo {
    ...
    private final static String[] modelPaths = new String[] { "31024.xml",
 			    "26241.xml", "26243.xml", "26245.xml", "26247.xml",
                            ...
                            "3303.xml", "1001.xml", "3304.xml", "3305.xml", "3306.xml", "3308.xml", "3310.xml", "3311.xml",
    ...
    private static final int OBJECT_ID_TEMPERATURE_SENSOR2 = 26241;
    private static final int OBJECT_ID_TEMPERATURE_SENSOR3 = 26243;
    private static final int OBJECT_ID_TEMPERATURE_SENSOR4 = 26245;
    private static final int OBJECT_ID_TEMPERATURE_SENSOR5 = 26247;
	...
	System.out.println("\n########## 9 ##########\n");
	//initializer.setInstancesForObject(SECURITY, noSec(serverURI, 123));
	initializer.setInstancesForObject(ACCESS_CONTROL, new MyAccess_Control());
	initializer.setInstancesForObject(CONNECTIVITY_STATISTICS, new MyConnectivity_Statistics());
	initializer.setInstancesForObject(CONNECTIVITY_MONITORING, new MyConnectivity_Monitoring());
	initializer.setInstancesForObject(FIRMWARE, new MyFirmware());
	initializer.setInstancesForObject(DEVICE, new MyDevice());
        initializer.setInstancesForObject(LOCATION, locationInstance);
	initializer.setInstancesForObject(OBJECT_ID_TEMPERATURE_SENSOR2, new Kepco_Man1());
	initializer.setInstancesForObject(OBJECT_ID_TEMPERATURE_SENSOR3, new Kepco_Man3());
	initializer.setInstancesForObject(OBJECT_ID_TEMPERATURE_SENSOR4, new Kepco_Man5());
	initializer.setInstancesForObject(OBJECT_ID_TEMPERATURE_SENSOR5, new Kepco_Man7());
