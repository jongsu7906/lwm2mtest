...
public class LeshanClientDemo {
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort, boolean needBootstrap,
        ...
        initializer.setInstancesForObject(SECURITY, Security(serverURI, false, securityMode?, publicKey or pskIdentity, serverPublicKey or pskKey, privateKey or ?, SERVER));
